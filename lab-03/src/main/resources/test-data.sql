insert into users values('fin_user_1', 'qqq', 1);
insert into authorities values('fin_user_1', 'ROLE_FIN_USER');

insert into users values('fin_user_2', 'qqq', 1);
...
insert into users values('it_user_2', 'qqq', 1);
insert into authorities values('it_user_2', 'ROLE_IT_USER');